...
function RevealHero({ 
  ...
  return (
    <div
      ...
      className={`reveal relative mx-auto w-full max-w-[320px] md:max-w-[380px] aspect-[576/1024] overflow-hidden bg-black select-none rounded-xl cursor-crosshair ${theme === 'venom' ? 'border border-[#EDEDED]/20 shadow-[0_0_30px_rgba(122,0,0,0.15)]' : 'border border-[#D6202A]/25 shadow-[0_0_30px_rgba(214,32,42,0.15)]'}`}
    >
      {/* Face Layer (Behind) */}
