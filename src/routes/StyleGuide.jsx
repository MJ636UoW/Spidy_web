          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-base font-body leading-relaxed text-zinc-350">
                  This is the standard body text. Used for descriptions, labels, and all primary content across both the Spider-Man and Venom skins to bind the platform together.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm font-mono text-theme-primary font-medium tracking-tight">
                  CODE: 0x992F | ACCENT: ACTIVE | VERSION: 4.0.0
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-theme-surface text-theme-bg p-6 rounded-lg flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm font-body text-zinc-800 leading-relaxed mb-4">
                  Symbiote bond is active. Subjecting the host to rapid structural mutation and cellular reinforcement.
                </p>
              </div>
              <button className="px-4 py-2 bg-theme-primary text-theme-bg font-mono font-bold text-sm text-center border border-theme-bg hover:bg-theme-bg hover:text-theme-primary transition duration-300 uppercase">
                Acknowledge Threat
              </button>
            </div>
          </div>
